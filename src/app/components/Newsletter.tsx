        ...
        <section className='py-20 bg-white dark:bg-dark/50 rounded-lg shadow-md overflow-hidden animate-slide-up'>
            <div className='p-8 md:p-12'>
                    <div className='max-w-7xl mx-auto'>
                        ...
                        <div>
                            <h2 className='text-2xl font-bold mb-4'>Terhubung dengan Saya</h2>
                            <p className='text-gray-600 dark:text-gray-300 md:w-2/3'>Mari terhubung! Dapatkan update terbaru seputar proyek dan tulisan blog saya. Saya akan berbagi apa yang sedang saya kerjakan dan pelajari, langsung ke inbox Anda.</p>
                        </div>
